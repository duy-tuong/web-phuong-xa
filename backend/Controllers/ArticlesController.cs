    ...
    public class ArticlesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateArticle(CreateArticleDTO dto)
        {
            ...
            var article = new Article
            {
                ...
                Excerpt = NormalizeOptional(dto.Excerpt),
                FeaturedImage = NormalizeOptional(dto.FeaturedImage),
                Content = dto.Content,
                ...
                Slug = await BuildUniqueSlugAsync(dto.Slug, dto.Title)
            };
        ...
        public async Task<IActionResult> UpdateArticle(int id, UpdateArticleDTO dto)
        {
            ...
            article.Slug = await BuildUniqueSlugAsync(dto.Slug, dto.Title, id);
