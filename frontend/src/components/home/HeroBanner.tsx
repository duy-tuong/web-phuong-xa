// công dụng của component này là hiển thị phần banner chính trên trang chủ, với các thông tin nổi bật về Cao Lãnh, các số liệu thống kê quan trọng, và các liên kết nhanh đến dịch vụ tra cứu hồ sơ và khám phá văn hóa. Banner này cũng có hiệu ứng chuyển đổi mượt mà giữa các slide để thu hút sự chú ý của người dùng.
"use client";
