//! hiện thị form liên hệ và góp ý, cho phép người dùng gửi yêu cầu trực tiếp đến hệ thống tiếp nhận hồ sơ. Form bao gồm các trường như họ tên, số điện thoại, email, dịch vụ cần liên hệ, và nội dung phản hồi. Component này cũng thực hiện việc lấy danh sách dịch vụ từ backend để hiển thị trong dropdown, và xử lý việc gửi dữ liệu lên backend khi người dùng submit form.
"use client";
