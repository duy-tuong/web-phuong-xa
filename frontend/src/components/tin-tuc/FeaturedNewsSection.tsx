...
export default function FeaturedNewsSection({
  ...
  const popularNews = [...articles]
    .sort((left, right) => parseViews(right.views) - parseViews(left.views))
    .slice(0, 3);
            ...
            <div className="flex flex-1 flex-col justify-between gap-4 p-4 sm:p-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="line-clamp-3 text-base leading-relaxed text-slate-600">
                  {featuredArticle.bodyLead}
                </p>
              </div>

              <div className="flex items-center gap-3 border-t border-[#1f7a5a]/10 pt-4">
                <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-[#1f7a5a]/20 bg-[#1f7a5a]/10 text-sm font-bold text-[#1f7a5a]">
        ...
        <div className="flex flex-col gap-6 rounded-xl border border-[#1f7a5a]/10 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4">
            <h3 className="flex items-center gap-2 text-lg font-bold text-slate-900">
              <span className="material-symbols-outlined text-[20px] text-[#1f7a5a]">
                trending_up
              </span>
              Tin đọc nhiều
            </h3>
